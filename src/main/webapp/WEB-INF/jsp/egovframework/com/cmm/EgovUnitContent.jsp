...
<div class="board">
	<div class="left dashboard_box1 ">
		<li onclick="window.open('${externalPageUrl[0]}/cop/bbs/selectArticleList.do?bbsId=BBSMSTR_000000000297')"><p class="circle">${fndNoticeArticleCnt }</p>재단공지</li>	
		<li onclick="window.open('${externalPageUrl[0]}/cop/bbs/selectArticleList.do?bbsId=BBSMSTR_000000000307')"><p class="circle">${extNoticeArticleCnt }</p>외부공지</li>	
		<li onclick="window.open('${externalPageUrl[0]}/cop/bbs/selectArticleList.do?bbsId=BBSMSTR_000000000310')"><p class="circle">${rcrtArticleCnt }</p>채용공고</li>	
		<li onclick="window.open('${externalPageUrl[0]}/cop/bbs/selectArticleList.do?bbsId=BBSMSTR_000000000309')"><p class="circle">${auctArticleCnt }</p>입찰공고</li>			
		...
		<li onclick="location.href='/busking/list_BuskingGroup.do';" class="circle_bg2"><img src="/images/egovframework/com/cmm/main/ic_dashboard_4.png"><br />버스킹 무대<br/>신청 관리</li>
