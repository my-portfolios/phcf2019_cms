...
import egovframework.phcf.util.EncryptUtil;
...
public class EgovFileScrty {
     ...
     * 
     * 2019-08-16 : 김경식
     * 본 프로그램인 기존 시스템의 회원 정보를 가져와야 하며
     * 기존 시스템의 암호화된 회원 정보를 그래도 이용하기 위해 해당 메소드를 수정해서 사용 함.
     * 
...
//		return new String(Base64.encodeBase64(hashValue));
    	...
    	return EncryptUtil.DigestSha256(password);
    }
