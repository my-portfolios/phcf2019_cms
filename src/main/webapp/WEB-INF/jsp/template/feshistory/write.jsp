...
<div class="wTableFrm">
	<!-- 타이틀 -->
	<h2>${pageTitle} <spring:message code="title.create" />, 템플릿명 : ${boardMasterVO.tmplatId}</h2><!-- 게시글 등록 -->
	...
	<tbody>
		...
		<tr>
			<th><label for="nttCn">${title } <span class="pilsu">*</span></label></th>
			<td class="nopd" colspan="3">
				<form:input path="ac6" title="${title} ${inputTxt}" size="70" maxlength="70" /> 
				<div><form:errors path="ac6" cssClass="error" /></div>  
			</td>
		</tr>
		...
		<tr>
			<th><label for="nttCn">${title } <span class="pilsu">*</span></label></th>
			<td class="nopd" colspan="3">
				<form:input path="ac7" title="${title} ${inputTxt}" size="70" maxlength="70" /> 
				<div><form:errors path="ac7" cssClass="error" /></div>  
			</td>
		</tr>
		...
		<tr>
			<th><label for="nttCn">${title } <span class="pilsu">*</span></label></th>
			<td class="nopd" colspan="3">
				<form:input path="ac8" title="${title} ${inputTxt}" size="70" maxlength="70" /> 
				<div><form:errors path="ac8" cssClass="error" /></div>  
			</td>
		</tr>
		</c:if>
